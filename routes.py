...
from controller_functions import index, regis, verif, finish, login, homepage, profile, signups, rehearse, validate, cancel, stores, concerts, upcoming, logout
...
app.add_url_rule('/profile/<id>', view_func=profile)
app.add_url_rule('/signups', view_func=signups)
app.add_url_rule('/rehearse', view_func=rehearse, methods=['POST'])
app.add_url_rule('/validated/<id>', view_func=validate)
app.add_url_rule('/cancel/<id>', view_func=cancel)
