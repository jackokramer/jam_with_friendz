...
from controller_functions import index, regis, verif, finish, login, homepage, signups, rehearse, stores, concerts, sessions, logout
...
app.add_url_rule('/sessions', view_func=sessions)
